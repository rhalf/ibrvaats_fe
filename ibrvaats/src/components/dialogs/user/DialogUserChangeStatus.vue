  ...
  <Dialog v-model="dialog" :width="480" expand>
    <Card>
      <v-card-title class="bg-primary pa-4">
        <Label header> Change Status </Label>
      </v-card-title>
      <v-card-text>
        <FormUserChangeStatus
          v-model="password"
          v-model:form="form"
          v-model:user="user"
        />
...
import FormUserChangeStatus from "@/components/forms/user/FormUserChangeStatus.vue";
